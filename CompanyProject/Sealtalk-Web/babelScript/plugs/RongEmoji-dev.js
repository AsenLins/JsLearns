...
;(function (global, factory) {
    ...
    if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && (typeof module === 'undefined' ? 'undefined' : _typeof(module)) !== undefined) {
     ...
     */
    var init = function init(newEmojis, opt) {
        addBaseCss();
    ...
    var addBaseCss = function addBaseCss() {
    ...
    var getNewEmojiFactory = function getNewEmojiFactory(newEmojis, opt) {
        var newEmojiFactory = {};
        if (newEmojis) {
    ...
    var setupEmojiRegExp = function setupEmojiRegExp(emojiFac, tagReg) {
    ...
    var computeBgPosition = function computeBgPosition(position, sizePx) {
    ...
    var getEmojiHtml = function getEmojiHtml(object) {
    ...
    var createSpan = function createSpan(emojiDetail, sizePx) {
        var emojiObj = {
    ...
    var calculateUTF = function calculateUTF(nativeEmoji) {
    ...
    var getEmojiBySymbol = function getEmojiBySymbol(symbol) {
     ...
     */
    var emojiDecode = function emojiDecode(emojis, reg) {
        reg = reg || configs.reg;
     ...
     * @return {string}          转化后的字符串
     */
    var emojiToSymbol = function emojiToSymbol(emojis, reg) {
     ...
     * @return {string}           
     */
    var symbolToEmoji = function symbolToEmoji(symbols) {
     ...
     */
    var emojiToHTML = function emojiToHTML(emojis, sizePx, reg) {
        emojis = emojiDecode(emojis, reg);
     ...
     * @return {span标签}       转化后，包含emoji背景的span标签
     */
    var symbolToHTML = function symbolToHTML(symbol, sizePx, reg) {
     ...
     */
    var getAllEmoji = function getAllEmoji() {
        return emojiDetails;
    };
