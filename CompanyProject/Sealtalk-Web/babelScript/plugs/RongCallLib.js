    ...
    var RongCallLib = function () {
        function RongCallLib(opt) {
            this._memorySessions = {
                ...
                isActiveCall: false,
                message: null,
                getChildNode: function getChildNode(localId, remoteStreamId) {
        ...
        RongCallLib.prototype.changeMediaType = function (converType, targetId, mediaType, callback) {
            var that = this,
                ...
                msg = new RongIMLib.MediaModifyMessage({ callId: channelInfo.Id, mediaType: RongIMLib.VoIPMediaType.MEDIA_AUDIO });
        ...
        RongCallLib.prototype.getSummaryMessage = function (message) {
            var that = this,
                startTime = this._memorySessions["startVoIPTime"],
                dateTime = startTime == 0 ? 0 : +new Date() - startTime;
        ...
        RongCallLib.prototype.initLocalStream = function (uId, mediaType) {
            var that = this,
                videoProfile = that.generateVideoProfile();
        ...
        RongCallLib.prototype.onReceived = function (message) {
            var that = this,
                channelInfo = that._memorySessions['chnl_' + message.targetId];
